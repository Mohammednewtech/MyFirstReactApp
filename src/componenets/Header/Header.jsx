...
import Icon from "../../../public/images/icons/logo-sm.png"
import Search from "../../../public/images/icons/search-icon-sm.png"
import Cart from "../../../public/images/icons/cart-sm.png"
import  "./bootstrap.css"
 ...
 <div className="nav-wrapper fixed-top">
		<div className="container">
			<nav className="navbar navbar-toggleable-sm navbar-expand-md">
			    ...
			    <a className="navbar-brand mx-auto" href="#"><img src={Icon} /></a>
